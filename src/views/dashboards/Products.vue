...
<template>
    <div class="col-lg-12">
                ...
                <div v-if="list_products.productForm" class="transaction-card">
                    <div v-if="list_products.getProdID !== null" class="">
                        <div class="row">
                            <div class="col-sm-8">
                                <h3>Product Edit</h3>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="d-flex justify-content-between mt-4">
                                            <h4><b>{{ list_products.updateProducts.name ? list_products.updateProducts.name : 'Product Name' }}</b></h4>
                                            <h4>₱ {{ list_products.updateProducts.price ? list_products.updateProducts.price : 0 }}</h4>
                                        </div>
                                        <span class="badge bg-success align-self-center">In Stock {{ list_products.updateProducts.stock ? list_products.updateProducts.stock: 0 }}</span>
                                        <p class="mt-2 text-justify">{{list_products.updateProducts.description ? list_products.updateProducts.description : 'No Descriptions'}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <h3>Detail Forms</h3>
                                <form @submit.prevent="list_products.updateProductFunction">
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" v-model="list_products.updateProducts.name" id="product-name" class="form-control">
                                        </div>
                                        
                                        <div class="col-6">
                                            <label for="cost">Cost</label>
                                            <input type="Number" v-model="list_products.updateProducts.price" id="cost" class="form-control">
                                        </div>
                                        <div class="col-6">
                                            <label for="cost">Stocks</label>
                                            <input type="Number" v-model="list_products.updateProducts.stock" id="cost" class="form-control">
                                        </div>
                                        <div class="col-12">
                                            <label for="cost">Description</label>
                                            <textarea v-model="list_products.updateProducts.description" class="form-control" id=""></textarea>
                                        </div>
                ...
                <div id="transaction-list">
                    <!-- Paid Transaction -->
                        <div v-if="list_products.products.length === 0">
                            <div class="transaction-card" data-status="paid" data-value="high">
                                <div class="row align-items-center">
                                    <div class="col-sm-12 text-center">
                                        <h5 class="m-0"><i class="fi fi-rr-box-open"></i> No Product Found</h5>
                                    </div>  
                                </div>
                            </div>
                        </div>
                        <div v-else>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-4 text-end">
                                    <button class="btn btn-success me-2" @click="list_products.idModifyProd(id)"> <i class="fi fi-rr-pencil"></i></button>
                                    <button class="btn btn-danger" @click="list_products.deleteProducts(id)"><i class="fi fi-rr-person-dragging-bag"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
